...
@Component({
  selector: 'matrix-hichart',
  templateUrl: './matrixHiChart.component.html',
  styleUrls: ['./matrixHiChart.component.css'],
})
export class HiChartComponent implements AfterViewInit {
  ...
  private createChartColumn(): void {
    ...
    const chart = Highcharts.chart('chart-column' as any, {
      ...
      tooltip: {
        headerFormat: `<div>Kuupäev: {point.key}</div>`,
