...
@Component({
  selector: 'matrix-inxput2',
  templateUrl: './matrixInxput2.component.html',
  styleUrls: [ './matrixInxput2.component.scss' ]
})
export class Inxput2Component implements OnInit  {
  name = 'Angular';
  numberValue = 0;
...
numbermks = 7;
  ...
  ngAfterViewInit() {
    let data: any,
      options: any,
      ctx: any = document.getElementById('lineChart2') as HTMLElement;
